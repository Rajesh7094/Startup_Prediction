...
loaded_model = pickle.load(open('C:/Users/bigil/Downloads/Startup-Company-Machine-Learning-main/Startup-Company-Machine-Learning-main/startup_model.sav', 'rb'))
